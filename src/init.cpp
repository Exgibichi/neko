...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += "  -port=<port>           " + strprintf(_("Listen for connections on <port> (default: %u or testnet: %u)"), 6161, 6163) + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + strprintf(_("Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"), 6162, 6162) + "\n";
...
{
    return FormatParagraph(strprintf(_("Copyright (C) 2013-%i The Neko core Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
